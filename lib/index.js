...
// Object.prototype.debug = function (format) {
//   console.log(format || 'debug', this);
//   return this;
// };
...
function SpecioClient(spec) {
  ...
  function _bindApi(path, spec) {
    let def = { 'head': _x, 'options': _x, 'delete': _y, 'get': _y, 'post': _z, 'put': _z, 'patch': _z };
    Object
      .keys(def)
...
SpecioClient.prototype = {
  ...
  request: function (path, method, params, query, body) {
    return new this._promiseConstructor((resolve, reject) => {
      ...
      let req = httpRequest[methodLowerCase](requestPath);
   ...
   * @returns {Promise}
   */
  put: function (path, body, params, query) {
   ...
   * @returns {Promise}
   */
  patch: function (path, body, params, query) {
